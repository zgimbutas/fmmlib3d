...
# SOURCE FILE LIST
#
vpath %.f .:..:../H3DLibraries_r2:../L3DLibraries_r2:../Quadratures:../Geometry:../Common:../src

FMODS = 

FSRCS = hfmm3dpart_driver.f hfmm3dpart.f hfmm3drouts.f \
     d3tstrcr.f d3mtreeplot.f  \
     prini.f h3dterms.f helmrouts3d.f h3dtrans.f projections.f cdjseval3d.f \
     prinm.f yrecursion.f \
     legeexps.f rotviarecur3.f rotproj.f dfft.f \
     hkrand.f dlaran.f 
