%
%  Test Helmholtz triangle FMMs in R^3
%
...
disp('')
'Helmholtz triangle target FMM in R^3'

tic
iprec=0
[U]=hfmm3dtria(iprec,zk,ntri,triangles,trianorm,source,ifcharge,charge,ifdipole,dipstr,dipvec,ifpot,iffld,ntarget,target,ifpottarg,iffldtarg);
total_time=toc
...
tic
iprec=0
[U]=hfmm3dtria(iprec,zk,ntri,triangles,trianorm,source,ifcharge,charge,ifdipole,dipstr,dipvec,ifpot,iffld);
total_time=toc
